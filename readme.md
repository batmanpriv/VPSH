...
- 📄 **Client scripts now support profiles and richer commands** (see [Client Setup Guide](#-client-setup-guide)).
...
1. [What's New in 3.3.1](#-whats-new-in-331)
2. [Overview](#-overview)
...
|----------|--------|-------------|
| 🪟 **Windows** | [`client-windows.bat`](https://github.com/batmanpriv/VPSH/releases/download/3.3.1/client-windows.bat) | Interactive and command-line proxy manager for Windows |
| 🐧 **Linux** | [`client-linux.sh`](https://github.com/batmanpriv/VPSH/releases/download/3.3.1/client-linux.sh) | Interactive and command-line proxy manager for Linux |
...
Only for Full Mode, the Hotspot ban tab, and Game Mode. Proxy Mode, PAC auto-setup, guest links, and BatProxy all work without root.
</details>
