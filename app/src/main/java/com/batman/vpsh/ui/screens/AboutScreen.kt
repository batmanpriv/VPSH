...
private const val CLIENT_WINDOWS_URL =
    "https://github.com/batmanpriv/VPSH/releases/download/3.3.1/client-windows.bat"
private const val CLIENT_LINUX_URL =
    "https://github.com/batmanpriv/VPSH/releases/download/3.3.1/client-linux.sh"
        ...
        SectionCard {
            Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
                ...
                GuideBlock(
                    ...
                    stringResource(R.string.about_guide_hotspot_title),
                    stringResource(R.string.about_guide_hotspot_desc)
                )
                GuideBlock(
                    Icons.Filled.Shield,
